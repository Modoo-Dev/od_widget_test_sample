...
// in od_widget_test/test/pages/article_image_check.dart.
...
import 'package:od_widget_test/logic/provider/article_provider.dart' as _i7;
import 'package:od_widget_test/models/workout_article.dart' as _i8;
import 'package:od_widget_test/services/article_api_service.dart' as _i5;
...
class _FakeArticleApiService_9 extends _i1.SmartFake
    implements _i5.ArticleApiService {
  _FakeArticleApiService_9(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
/// A class which mocks [ArticleProvider].
///
/// See the documentation for Mockito's code generation for more information.
class MockArticleProvider extends _i1.Mock implements _i7.ArticleProvider {
  @override
  _i5.ArticleApiService get articleApiService => (super.noSuchMethod(
        Invocation.getter(#articleApiService),
        returnValue: _FakeArticleApiService_9(
          this,
          Invocation.getter(#articleApiService),
        ),
        returnValueForMissingStub: _FakeArticleApiService_9(
          this,
          Invocation.getter(#articleApiService),
        ),
      ) as _i5.ArticleApiService);

  @override
  set articleApiService(_i5.ArticleApiService? _articleApiService) =>
      super.noSuchMethod(
        Invocation.setter(
          #articleApiService,
          _articleApiService,
  ...
  @override
  List<_i8.WorkoutArticle> get workoutArticleList => (super.noSuchMethod(
        Invocation.getter(#workoutArticleList),
        returnValue: <_i8.WorkoutArticle>[],
        returnValueForMissingStub: <_i8.WorkoutArticle>[],
      ) as List<_i8.WorkoutArticle>);

  @override
  String get sample => (super.noSuchMethod(
        Invocation.getter(#sample),
        returnValue: _i6.dummyValue<String>(
          this,
          Invocation.getter(#sample),
        ),
  ...
  @override
  _i4.Future<void> getArticles() => (super.noSuchMethod(
        Invocation.method(
          #getArticles,
          [],
        ),
